...
import (
	...
	// driverv1_implementation "github.com/escoutdoor/linko/driver/internal/api/driver/v1"
	"github.com/escoutdoor/linko/catalog/internal/config"
	"github.com/escoutdoor/linko/catalog/internal/interceptor"
	"github.com/escoutdoor/linko/catalog/internal/metrics"
...
func (a *App) initGrpcServer(ctx context.Context) error {
	...
	// driverv1Impl := driverv1_implementation.New(a.di.DriverService(ctx))
	//
	// driverv1.RegisterDriverServiceServer(grpcServer, driverv1Impl)
...
func (a *App) initHttpServer(ctx context.Context) error {
	...
	// if err := driverv1.RegisterDriverServiceHandlerFromEndpoint(ctx, gwMux, config.Config().GrpcServer.Address(), opts); err != nil {
	// 	return errwrap.Wrap("register driver service handler from endpoint", err)
	// }
